...
namespace CheengizsStore.Migrations
{
    ...
    [Migration("20250528183430_ColorationAddedAndSneakerColor")]
    partial class ColorationAddedAndSneakerColor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CheengizsStore.Entities.Cart", b =>
                {
                    ...
                    b.Property<int>("SneakerToSaleId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CheengizsStore.Entities.SneakerToSale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CheengizsStore.Entities.Cart", b =>
                {
                    ...
                    b.HasOne("CheengizsStore.Entities.SneakerToSale", "SneakerToSale")
                        .WithMany("Carts")
                        .HasForeignKey("SneakerToSaleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Account");

                    b.Navigation("SneakerToSale");
                });
